...
class Command(BaseCommand):
    ...
    def __init__(self):
        ...
        self.__handler_map = {
            TaskCheckType.TommorowTasksRemind: Command.handle_tommorow_tasks_remind,
            TaskCheckType.TommorowImportantTasksCheck: Command.handle_tommorow_important_tasks_check,
            TaskCheckType.SoonTasksRemindAndCheck: Command.handle_soon_tasks_remind_and_check,
        }
